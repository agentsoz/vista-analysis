...
![](vista-MountEliza-formal_files/figure-html/unnamed-chunk-4-1.png)<!-- -->

```r
ggplot(Persons,aes(x=Persons$AgeGroup_RW,fill=Persons$MAINACT)) + geom_bar(position = "fill")
```

![](vista-MountEliza-formal_files/figure-html/unnamed-chunk-4-2.png)<!-- -->
...
![](vista-MountEliza-formal_files/figure-html/unnamed-chunk-6-1.png)<!-- -->

```r
ggplot(finalset,aes(x=finalset$AgeGroup,fill=finalset$MainAct)) + geom_bar(position = "fill")
```

![](vista-MountEliza-formal_files/figure-html/unnamed-chunk-6-2.png)<!-- -->
