...
```r
PersonsSuburb <- read.csv("../../synthetic-population/data/melbourne-2016-population/melbourne/generated/SA2/Melbourne/population/persons.csv")
...
![](Melbourne-cista_files/figure-html/unnamed-chunk-5-1.png)<!-- -->

```r
ggplot(Persons,aes(x=Persons$AgeGroup_RW,fill=Persons$MAINACT)) + geom_bar(position = "fill")
```

![](Melbourne-cista_files/figure-html/unnamed-chunk-5-2.png)<!-- -->
...
![](Melbourne-cista_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](Melbourne-cista_files/figure-html/unnamed-chunk-19-1.png)<!-- -->
...
![](Melbourne-cista_files/figure-html/unnamed-chunk-31-1.png)<!-- -->
...
![](Melbourne-cista_files/figure-html/unnamed-chunk-43-1.png)<!-- -->
...
![](Melbourne-cista_files/figure-html/unnamed-chunk-56-1.png)<!-- -->

```r
ggplot(finalset,aes(x=finalset$AgeGroup,fill=finalset$MainAct)) + geom_bar(position = "fill")
```

![](Melbourne-cista_files/figure-html/unnamed-chunk-56-2.png)<!-- -->
...
![](Melbourne-cista_files/figure-html/unnamed-chunk-68-1.png)<!-- -->

```r
ggplot(formalsetEdu,aes(x=formalsetEdu$MAINACT,y=formalsetEdu$STARTIME,fill=formalsetEdu$AgeGroup))+geom_boxplot()
```

![](Melbourne-cista_files/figure-html/unnamed-chunk-68-2.png)<!-- -->
...
![](Melbourne-cista_files/figure-html/unnamed-chunk-71-1.png)<!-- -->

```r
ggplot(formalsetEdu,aes(x=formalsetEdu$MAINACT,y=formalsetEdu$JTEDIST,fill=formalsetEdu$AgeGroup))+geom_boxplot()
```

![](Melbourne-cista_files/figure-html/unnamed-chunk-71-2.png)<!-- -->
...
![](Melbourne-cista_files/figure-html/unnamed-chunk-80-1.png)<!-- -->

```r
ggplot(formalset,aes(x=formalset$JTMMODE,y=formalset$JFMSpeed))+geom_boxplot()
```

![](Melbourne-cista_files/figure-html/unnamed-chunk-80-2.png)<!-- -->
