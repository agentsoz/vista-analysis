...
dataset2 <- subset(dataset2,dataset2$JTEMODE!="Taxi")
...
line_reg = randomForest(x=dataset2[-3],y=dataset2$Speed,ntree = 100,weights = Trips$CW_ADJTEWGT_LGA)
formalset$JFMSpeed = predict(line_reg, test_set)


formalset$JFMTime <- formalset$JTMDIST/formalset$JFMSpeed
